...
* Pattern embeddings and Qdrant vector search are configured in `Settings > Flavor Agent`. Supported embedding backends are Azure OpenAI, OpenAI Native, and explicitly selected Cloudflare Workers AI.
