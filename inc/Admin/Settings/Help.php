			...
			[
				...
				'content'  => implode(
					...
					[
						...
						'<ul>',
						'<li>' . esc_html__( 'OpenAI Native and Cloudflare Workers AI fields configure the single Flavor Agent embedding model. Chat credentials and text generation live in Settings > Connectors.', 'flavor-agent' ) . '</li>',
