...
final class Feedback
{
	...
	private static function get_safe_validation_error_message(string $settings_error_code, \WP_Error $error): string
	{
		...
		return match ($settings_error_code) {
			...
			'flavor_agent_cloudflare_ai_search_validation' => __('Legacy developer docs override validation failed. Check the Cloudflare account, instance, and API token, then try again.', 'flavor-agent'),
