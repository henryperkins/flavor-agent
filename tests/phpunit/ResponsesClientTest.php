...
final class ResponsesClientTest extends TestCase {
	...
	public function test_rank_routes_through_unpinned_wordpress_ai_client(): void {
		$this->configure_openai_connector();
	...
	public function test_rank_falls_back_to_saved_reasoning_effort_option_when_no_explicit_value(): void {
		$this->configure_openai_connector();
		WordPressTestState::$options[ Config::OPTION_REASONING_EFFORT ] = 'xhigh';
		WordPressTestState::$ai_client_generate_text_result             = '{"explanation":"ok"}';
	...
	public function test_rank_falls_back_to_legacy_azure_reasoning_effort_option_when_neutral_option_is_missing(): void {
		$this->configure_openai_connector();
		WordPressTestState::$options[ Config::OPTION_LEGACY_AZURE_REASONING_EFFORT ] = 'xhigh';
		WordPressTestState::$ai_client_generate_text_result                          = '{"explanation":"ok"}';
	...
	public function test_rank_falls_back_to_default_medium_when_saved_reasoning_effort_is_invalid(): void {
		$this->configure_openai_connector();
		WordPressTestState::$options[ Config::OPTION_REASONING_EFFORT ] = 'definitely-not-valid';
		WordPressTestState::$ai_client_generate_text_result             = '{"explanation":"ok"}';
