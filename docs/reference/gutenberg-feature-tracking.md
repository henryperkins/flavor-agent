...
Latest Gutenberg release at snapshot: `23.4.0` (published 2026-06-17; local alignment has started with the parser/copy seams listed below, while browser runtime evidence remains open).
