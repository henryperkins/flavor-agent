...
| `GET /flavor-agent/v1/attestations/{id}/verification` | Public                                                | AI Activity verification action                 | `AttestationController::get_verification()`                                                               | Returns the site-served verification summary (`outcomes`, `subjectError`, revert/supersession ids). Convenience UX only; independent verification remains the standalone HTTP verifier |
