...
| Content                           | None                                                                                                                         | `Editorial Notes` via `AIAdvisorySection`                                                                                             | Hero eyebrow is `Generated Content Guidance`; mode pill is `Draft`, `Edit`, or `Critique`; generated text can be copied manually  | Editorial output and review notes, no apply lane            |
