...
| `WordPress/ai#437` | AI Request Logging                                                                                   | Merged PR    | Directly collides with `inc/Activity/Repository.php`, `inc/Activity/Serializer.php`, and `src/admin/activity-log.js`.    |
...
| `WordPress/ai#437` — Request Logging                                                              | `inc/Activity/Repository.php`, `inc/Activity/Serializer.php`, `src/admin/activity-log.js` | Core AI request logging now exists. Decide whether Flavor Agent admin activity forwards into it or keeps only the editor-inline history local. |
