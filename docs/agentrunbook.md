...
now lands on the live entity; the approval re-checks the freshness baseline first.
...
Page-scope content lane confirmed at `page:256`. Provider serving `openai`/`gpt-5.1`.
