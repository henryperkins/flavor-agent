...
Implementation note (2026-08-02): Slice 1 is implemented and locally verified in the isolated working tree. Fresh targeted evidence is green across all seven primary suites: `ExternalApplyLifecycleTest` (51 tests / 315 assertions), `ApplyAbilitiesTest` (36 / 230), `ActivityPermissionsTest` (18 / 52), `StyleApplyExecutorTest` (25 / 107), `TemplateApplyExecutorTest` (34 / 180), `TemplatePartApplyExecutorTest` (52 / 259), and `PostBlocksApplyExecutorTest` (26 / 113), for 242 tests / 1,256 assertions total. The slice remains uncommitted, unpushed, without a pull request, unmerged, undeployed, without browser evidence, and without final-SHA verifier evidence. Slice 2, Slice 3, and Slice 4 implementation has not started.
